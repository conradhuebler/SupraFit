...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Analyser_t, stringdata0) + ofs), len 
...
const QMetaObject Analyser::staticMetaObject = { {
    QMetaObject::SuperData::link<SupraFitCli::staticMetaObject>(),
    qt_meta_stringdata_Analyser.offsetsAndSize,
    qt_meta_data_Analyser,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Analyser_t
...
void *Analyser::qt_metacast(const char *_clname)
{
    ...
    return SupraFitCli::qt_metacast(_clname);
}

int Analyser::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SupraFitCli::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
