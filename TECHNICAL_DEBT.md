...
- **D1 – Test-Sicherheitsnetz zuerst** 🔴
  *Frage:* Warum nur 39 %? Ursachen: `test_dataclass`-Timeout (30 s), API-Mismatches nach
  TestUtils-Migration, `test_projectmanager.cpp` nicht registriert.
  *Warum tief:* Voraussetzung für **jede** weitere Migration – ohne grüne Tests kein sicheres Refactoring.
