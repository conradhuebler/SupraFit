...
const QString git_commit_hash = "388ea28"; /*! Current hash of the git branch */
const QString git_branch = "master";      /*! Current name of the branch as printable string    */
const QString git_tag = "2.5.76";      /*! Current name of the branch as printable string    */

#ifdef _UNIX
const QString git_date = "Commit Date: Mon, 18 Oct 2021 18:47:34 +0200"; /*! Current date of the git branch branch as printable string*/
#else
...
const QString commit_hash = "Commit: 388ea28 --"; /*! Current hash of the git branch branch as printable string*/

#ifdef _UNIX
const QString date = "Commit Date: Mon, 18 Oct 2021 18:47:34 +0200"; /*! Current date of the git branch branch as printable string*/
#else
