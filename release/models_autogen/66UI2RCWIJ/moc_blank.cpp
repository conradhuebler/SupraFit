...
#include <memory>
#include "../../../src/core/models/titrations/itc/blank.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Blank_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Blank_t qt_meta_stringdata_Blank = {
    {
QT_MOC_LITERAL(0, 5) // "Blank"
...
const QMetaObject Blank::staticMetaObject = { {
    ...
    qt_meta_stringdata_Blank.offsetsAndSize,
    qt_meta_data_Blank,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Blank_t
...
void *Blank::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Blank.stringdata0))
