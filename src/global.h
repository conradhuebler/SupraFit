...
inline QString aboutHtml()
{
    ...
    info += "<h4>" + QString(version).replace("\n", "<br />") + "</h4>";
    ...
    info += "<p>If you obtain results with SupraFit, I kindly ask to cite: </p><p>C. Hübler, conradhuebler/SupraFit: 2019, Zenodo. <a href='http://doi.org/10.5281/zenodo.3364570'>http://doi.org/10.5281/zenodo.3364570</a>.<p>";
...
inline QString about()
{
    ...
    info += "\tIf you obtain results with SupraFit, I kindly ask to cite: C. Hübler, conradhuebler/SupraFit: 2019, Zenodo. http://doi.org/10.5281/zenodo.3364570\n";
