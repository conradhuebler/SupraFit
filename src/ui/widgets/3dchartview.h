...
public:
    ...
    inline void setMaxZ(double val)
    {
        Max_Z = val;
        ApplayRanges();
    }
    inline void setMinZ(double val)
    {
        Min_Z = val;
        ApplayRanges();
    }
    inline void setMaxX(double val)
    {
        Max_X = val;
        ApplayRanges();
    }
    inline void setMinX(double val)
    {
        Min_X = val;
        ApplayRanges();
    }
    inline void setMaxY(double val)
    {
        Max_Y = val;
        ApplayRanges();
    }
    inline void setMinY(double val)
    {
        Min_Y = val;
        ApplayRanges();
    }
