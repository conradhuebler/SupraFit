...
// Claude Generated: split out of analyse.cpp (2026) — string/HTML formatting layer.
// Contains the human-readable / legacy string-returning StatisticTool functions
// (AnalyseReductionAnalysis, CompareCV, CompareMC, CompareAIC, FormatStatisticsString).
// The JSON compute functions (Calculate*Metrics, Extract*) remain in analyse.cpp.
// Declarations for both translation units live in the shared facade analyse.h.
