...
class EyringFit : public AbstractModel {
    Q_OBJECT

public:
    EyringFit(DataClass* data);
    EyringFit(AbstractModel* data);

    virtual ~EyringFit() override;

    virtual inline SupraFit::Model SFModel() const override { return SupraFit::Eyring; }
