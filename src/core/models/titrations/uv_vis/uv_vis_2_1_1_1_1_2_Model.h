...
class uv_vis_IItoI_ItoI_ItoII_Model : public AbstractTitrationModel {
    Q_OBJECT
...
public:
    ...
    uv_vis_IItoI_ItoI_ItoII_Model(DataClass* data);
    uv_vis_IItoI_ItoI_ItoII_Model(AbstractTitrationModel* data);

    virtual ~uv_vis_IItoI_ItoI_ItoII_Model() override;

    virtual inline SupraFit::Model SFModel() const override { return SupraFit::uv_vis_IItoI_ItoI_ItoII; }
