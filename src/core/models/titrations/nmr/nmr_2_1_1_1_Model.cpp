...
#include "nmr_2_1_1_1_Model.h"

nmr_IItoI_ItoI_Model::nmr_IItoI_ItoI_Model(DataClass* data)
    : AbstractNMRModel(data)
{
    PrepareParameter(GlobalParameterSize(), LocalParameterSize());
}

nmr_IItoI_ItoI_Model::nmr_IItoI_ItoI_Model(AbstractNMRModel* data)
    : AbstractNMRModel(data)
{
    PrepareParameter(GlobalParameterSize(), LocalParameterSize());
}

nmr_IItoI_ItoI_Model::~nmr_IItoI_ItoI_Model()
{
}

void nmr_IItoI_ItoI_Model::DeclareOptions()
{
...
void nmr_IItoI_ItoI_Model::EvaluateOptions()
{
...
void nmr_IItoI_ItoI_Model::InitialGuess_Private()
{
    int index_21 = 0;
    ...
    LocalTable()->setColumn(DependentModel()->lastRow(), 2);
...
QSharedPointer<AbstractModel> nmr_IItoI_ItoI_Model::Clone(bool statistics)
{
    QSharedPointer<nmr_IItoI_ItoI_Model> model = QSharedPointer<nmr_IItoI_ItoI_Model>(new nmr_IItoI_ItoI_Model(this), &QObject::deleteLater);
    finishClone(model, statistics);
    return model;
}

QString nmr_IItoI_ItoI_Model::ParameterComment(int parameter) const
{
    if (parameter == 0)
...
QString nmr_IItoI_ItoI_Model::ModelInfo() const
{
...
QString nmr_IItoI_ItoI_Model::AdditionalOutput() const
{
...
QString nmr_IItoI_ItoI_Model::AnalyseMonteCarlo(const QJsonObject& object, bool forceAll) const
{
    return prependBC50(AbstractNMRModel::AnalyseMonteCarlo(object, forceAll), forceAll, Statistic::MonteCarlo2BC50_2_1(GlobalParameter(0), GlobalParameter(1), object));
}

QString nmr_IItoI_ItoI_Model::AnalyseGridSearch(const QJsonObject& object, bool forceAll) const
{
    return prependBC50(AbstractNMRModel::AnalyseGridSearch(object, forceAll), forceAll, Statistic::GridSearch2BC50_2_1(GlobalParameter(0), GlobalParameter(1), object));
}
#include "nmr_2_1_1_1_Model.moc"
