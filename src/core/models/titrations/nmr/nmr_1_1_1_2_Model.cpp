...
#include "nmr_1_1_1_2_Model.h"

nmr_ItoI_ItoII_Model::nmr_ItoI_ItoII_Model(DataClass* data)
    : AbstractNMRModel(data)
{
    PrepareParameter(GlobalParameterSize(), LocalParameterSize());
}

nmr_ItoI_ItoII_Model::nmr_ItoI_ItoII_Model(AbstractNMRModel* data)
    : AbstractNMRModel(data)
{
    PrepareParameter(GlobalParameterSize(), LocalParameterSize());
}

nmr_ItoI_ItoII_Model::~nmr_ItoI_ItoII_Model()
{
}

void nmr_ItoI_ItoII_Model::DeclareOptions()
{
...
void nmr_ItoI_ItoII_Model::EvaluateOptions()
{
...
void nmr_ItoI_ItoII_Model::InitialGuess_Private()
{
...
QSharedPointer<AbstractModel> nmr_ItoI_ItoII_Model::Clone(bool statistics)
{
    QSharedPointer<nmr_ItoI_ItoII_Model> model = QSharedPointer<nmr_ItoI_ItoII_Model>(new nmr_ItoI_ItoII_Model(this), &QObject::deleteLater);
...
QString nmr_ItoI_ItoII_Model::ParameterComment(int parameter) const
{
    if (parameter == 0)
