...
class AbstractNMRModel : public AbstractTitrationModel {
    Q_OBJECT
...
#pragma message("things got removed, because they seem to be old")
    ...
    AbstractNMRModel(DataClass* data);
    AbstractNMRModel(AbstractNMRModel* other);
    virtual ~AbstractNMRModel() override;
