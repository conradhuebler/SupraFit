...
public:
    ...
    ItoI_ItoII_Model(AbstractTitrationModel* data);

    virtual ~ItoI_ItoII_Model() override;

    virtual inline SupraFit::Model SFModel() const override { return SupraFit::ItoI_ItoII; }
