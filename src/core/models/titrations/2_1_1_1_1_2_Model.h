...
public:
    ...
    IItoI_ItoI_ItoII_Model(AbstractTitrationModel* data);

    virtual ~IItoI_ItoI_ItoII_Model() override;

    virtual inline SupraFit::Model SFModel() const override { return SupraFit::IItoI_ItoI_ItoII; }
