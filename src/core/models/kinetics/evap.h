...
class EvapMonoModel : public AbstractModel {
    Q_OBJECT
...
public:
    ...
    EvapMonoModel(DataClass* data);
    EvapMonoModel(AbstractModel* data);

    virtual ~EvapMonoModel() override;

    virtual inline SupraFit::Model SFModel() const override { return SupraFit::EvapMModel; }
